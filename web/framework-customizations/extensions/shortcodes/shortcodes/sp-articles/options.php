    ...
    'get_mehtod' => array(
        ...
        'picker' => array(
            'gadget' => array(
                'type' => 'select',
                'value' => 'by_cats',
                'desc' => esc_html__('Select articles by category or item', 'listingo'),
        ...
        'choices' => array(
            'by_cats' => array(
                'categories' => array(
                    ...
                    'prepopulate' => 500,
                    'desc' => esc_html__('Show articles from authors who are under selected caetgories. Leave it empty to show from all.', 'listingo'),
                ),
            ...
            'by_posts' => array(
                'posts' => array(
                    ...
                    'source' => 'sp_articles',
                    'prepopulate' => 500,
                    'desc' => esc_html__('Show articles by post selection.', 'listingo'),
                ),
            )
        ),
        'show_borders' => true,
