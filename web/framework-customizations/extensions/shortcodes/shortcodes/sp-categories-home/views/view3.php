...
$show_buttons 	= !empty($atts['cat_view']['view3']['show_buttons']) ? $atts['cat_view']['view3']['show_buttons'] : array();
			...
			<div class="tg-generallabor">
				...
				<?php 
					...
					foreach ($show_buttons as $key => $value) {
						...
						if ( !empty( $btn_text ) ) {
				?>		
						<a class="tg-btnviewcatagories" href="<?php echo esc_attr( $btn_link ); ?>"><?php echo esc_attr( $btn_text ); ?></a>			
					<?php } } ?>
					<?php } ?>
			</div>
		</div>
