...
class FW_Option_Type_NewIcon extends FW_Option_Type {
    ...
    private function generate_unknown_set($icon) {
        return array (
		   ...
		   'container-class' => '' ,
		   'groups'          => array (
							  'unknown' => esc_html__('Unknown Set' , 'listingo') ,
		   ) ,
		   'icons'           => array (
    ...
    private function get_default_sets() {
		...
		//     groups => array(
        //         array(
        //             'title' => esc_html__('Web Application Icons', 'listingo')
        //             'icons' => array('fa fa-adjust', 'fa fa-anchor', ...),
        //         ),
        //         array(
        //             'title' => esc_html__('Transportation Icons', 'listingo'),
        //             'icons' => array(...),
        //         ),
        //     )
        //
        ...
        return array (
		   'font-awesome' => array (// http://fortawesome.github.io/Font-Awesome/icons
			  ...
			  'groups'          => array (
				 'web-application' => esc_html__('Web Application Icons' , 'listingo') ,
				 'hand'            => esc_html__('Hand Icons' , 'listingo') ,
				 'transportation'  => esc_html__('Transportation Icons' , 'listingo') ,
				 'gender'          => esc_html__('Gender Icons' , 'listingo') ,
				 'file-type'       => esc_html__('File Type Icons' , 'listingo') ,
				 //'spinner'         => 'Spinner Icons',
				 //'form-control'    => 'Form Control Icons',
				 'payment'         => esc_html__('Payment Icons' , 'listingo') ,
				 //'chart'           => 'Chart Icons',
				 'currency'        => esc_html__('Currency Icons' , 'listingo') ,
				 'text-editor'     => esc_html__('Text Editor Icons' , 'listingo') ,
				 'directional'     => esc_html__('Directional Icons' , 'listingo') ,
				 'video-player'    => esc_html__('Video Player Icons' , 'listingo') ,
				 'brand'           => esc_html__('Brand Icons' , 'listingo') ,
				 'medical'         => esc_html__('Medical Icons' , 'listingo') ,
				 'listingo'         => esc_html__('Listingo Icons' , 'listingo') ,
			  ) ,
			  'icons' => array(
					...
					"lnr lnr-map-marker" => array('group' => 'listingo'),
					"lnr lnr-clock" => array('group' => 'listingo'),
					"lnr lnr-phone-handset" => array('group' => 'listingo'),
					"lnr lnr-magnifier" => array('group' => 'listingo'),
					"lnr lnr-cart" => array('group' => 'listingo'),
					"lnr lnr-pie-chart" => array('group' => 'listingo'),
					"lnr lnr-cloud-check" => array('group' => 'listingo'),	
					"lnr lnr-book" => array('group' => 'listingo'),		
					"lnr lnr-screen" => array('group' => 'listingo'),			
					"lnr lnr-rocket" => array('group' => 'listingo'),	
					"lnr lnr-smile" => array('group' => 'listingo'),		
					"lnr lnr-coffee-cup" => array('group' => 'listingo'),		
					"lnr lnr-earth" =>array('group' => 'listingo'),	
					"lnr lnr-calendar-full" => array('group' => 'listingo'),
					"lnr lnr-map" => array('group' => 'listingo'),
					"lnr lnr-user" => array('group' => 'listingo'),
					"lnr lnr-bullhorn" => array('group' => 'listingo'),
					"lnr lnr-phone-handset" => array('group' => 'listingo'),	
					"lnr lnr-printer" => array('group' => 'listingo'),		
					"lnr lnr-envelope" => array('group' => 'listingo'),		
					"lnr lnr-heart-pulse" => array('group' => 'listingo'),		
					"lnr lnr-construction" => array('group' => 'listingo'),	
					"lnr lnr-laptop" => array('group' => 'listingo'),	
