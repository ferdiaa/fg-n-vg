...
if( !function_exists('listingo_process_paypal_payment') ){
	function listingo_process_paypal_payment( $sandbox, $api_username, $api_password, $api_signature, $currency, $fees_payer, $receivers, $return_page, $ipn_page, $appid, $cancel_url = '' ) { 	 
