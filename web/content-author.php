						...
						<div class="tg-authorhead">
							<div class="tg-leftbox">
								<div class="tg-authorname">
									...
									<time datetime="2017-12-12"><?php esc_html_e ('Author Since:', 'listingo'); ?> <?php echo date_i18n(get_option('date_format'), strtotime($registered)); ?></time>        
								</div>
							</div>
