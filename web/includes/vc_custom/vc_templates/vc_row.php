...
if ( ! empty( $full_width ) ) {
	...
	if ( 'stretch_row_content' === $full_width ) {
		...
		$wrapper_attributes[] = 'data-vc-stretch-content="true"';
		$css_classes[] = 'vc_row-no-padding listingo-section-no-padding';
	}
...
if ( ! empty( $parallax_image ) ) {
	...
	$wrapper_attributes[] = ' data-parallax="scroll" data-position="center 0" data-image-src="'.$parallax_image_src.'"';
	$css_classes[] = ' tg-parallaximg';
}
