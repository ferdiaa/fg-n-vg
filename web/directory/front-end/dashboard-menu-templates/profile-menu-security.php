...
?>
 <li class="<?php echo ( $reference === 'security_settings' ? 'tg-active' : ''); ?>">
	<a href="<?php Listingo_Profile_Menu::listingo_profile_menu_link($profile_page, 'security_settings', $user_identity); ?>">
		<i class="lnr lnr-construction"></i>
		<span><?php esc_html_e('Security Settings', 'listingo'); ?></span>
		<?php do_action('listingo_get_tooltip','menu','menu_security');?>
	</a>
</li>