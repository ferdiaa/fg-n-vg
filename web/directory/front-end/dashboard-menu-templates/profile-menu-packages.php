...
?>
<li class="tg-updatepackage <?php echo ( $reference === 'package' ? 'tg-active' : ''); ?>"> 
	<a href="<?php Listingo_Profile_Menu::listingo_profile_menu_link($profile_page, 'package', $user_identity); ?>">
