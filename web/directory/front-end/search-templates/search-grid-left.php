...
?>
<div class="tg-listing tg-listingvtwo sp-search-left">
	...
	<div class="tg-serviceproviders">
		<form class="sp-form-search" action="" method="get">
			<div class="tg-themeform tg-formsearch">
				...
				<a id="tg-btnadvancefilters" class="tg-btnadvancefilters" href="javascript:;">
					<span><?php esc_html_e('Advanced Filters', 'listingo'); ?></span> <i class="fa fa-angle-right"></i>
				</a>
			</div>
						...
						<?php
							...
							if (!empty($user_query)) {
								...
								foreach ($user_query as $user) {
									...
									?>
								<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 box tg-verticaltop">
