...
?>
<div class="sp-search-filter-list sp-search-filterts">
	<form class="sp-form-search" action="" method="get">
		<div class="tg-mapinnerbanner">
			...
			<?php do_action('listingo_get_search_toggle_map'); ?>
		</div>
		<div class="container">
			<div class="row">
					...
					<div class="col-xs-12 col-sm-7 col-md-8 col-lg-9 pull-right">
						<div class="row">
							<div id="tg-content" class="tg-content">
								<div class="tg-listing tg-gridview">
									...
									<div class="tg-serviceproviders row">
									 <?php
