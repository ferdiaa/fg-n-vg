 ...
 * @since 1.0
 */
do_action('listingo_post_views', get_the_ID(),'article_views');
get_header();
global $post;
                    ...
                    while (have_posts()) {
                        ...
                        <div id="tg-content" class="tg-content">
                            <article class="tg-post tg-detailpage tg-postdetail">
                                ...
                                <div class="tg-postcontent">
                                    ...
                                    <ul class="tg-postmatadata">
                                        <li>
                                            <a href="javascript:;">
                                                <i class="lnr lnr-user"></i><span>
                                                    <?php
														esc_html_e(' Written by', 'listingo');
														echo '&nbsp;'.esc_attr(get_the_author()).'&nbsp;';
														esc_html_e('for', 'listingo');
                                        ...
                                        <li><a href="javascript:;"><i class="lnr lnr-eye"></i><span><?php echo intval($post_view_count); ?></span></a></li>
                                    </ul>
                                </div>
                            ...
                            <div class="tg-tagsshare blog_single">
                                <?php listingo_get_post_categories($post->ID, 'tg-tag', 'article_tags', 'Tags'); ?>
                                <?php listingo_prepare_social_sharing(false, esc_html__('Share this Article', 'listingo'), 'true', '', $thumbnail); ?>
                            </div>
                            <div class="tg-author">
                                <?php if (!empty($avatar)) { ?>
                                    <figure>
                                        <a href="<?php echo esc_url(get_author_posts_url(get_the_author_meta('ID'))); ?>">
                                            <img src="<?php echo esc_url($avatar); ?>" alt="<?php esc_attr_e('Avatar', 'listingo'); ?>"></a>
                                    </figure>
                                <?php } ?>
