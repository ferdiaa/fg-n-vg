...
if (!class_exists('listingo_core')) {
    ...
    class Listingo_Core {
         ...
         *
         * - Listingo_Loader. Orchestrates the hooks of the plugin.
         * - Listingo_i18n. Defines internationalization functionality.
         * - Listingo_Admin. Defines all hooks for the admin area.
         * - Listingo_Public. Defines all hooks for the public side of the site.
         *
        ...
        private function load_dependencies() {
            ...
            $this->loader = new Listingo_Loader();
        }

        /**
         * Define the locale for this plugin for internationalization.
         *
         * Uses the Listingo_i18n class in order to set the domain and to register the hook
         * with WordPress.
         *
         * @since    1.0.0
         * @access   private
        ...
        private function define_admin_hooks() {
            $plugin_admin = new Listingo_Admin();
        ...
        private function define_public_hooks() {
            ...
            $plugin_public = new Listingo_Public();
         ...
         *
         * @since     1.0.0
         * @return    Listingo_Loader    Orchestrates the hooks of the plugin.
         */
