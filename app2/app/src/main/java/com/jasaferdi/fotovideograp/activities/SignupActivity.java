...
import com.jasaferdi.fotovideograp.Model.RegisterUser;
...
import static com.jasaferdi.fotovideograp.Retrofit.RetrofitUtil.SignupUser;
...
public class SignupActivity extends BaseActivity implements OnSignupLoginListener {
    ...
    private void signUp() {
        ...
        businessUser.setCategory(categories.getSelectedItem().toString());
        businessUser.setSubCategory(subCategories.getSelectedItem().toString());

        if (registerBusiness.isSelected()) {

            int selectedId = registerType.getCheckedRadioButtonId();
            RadioButton radioButton = (RadioButton) findViewById(selectedId);
            businessUser.setType(radioButton.getText().toString().toLowerCase());
        } else {
