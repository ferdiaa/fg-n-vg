 ...
 */
public class MyAppointmentsRecyclerViewAdapter2 extends RecyclerView.Adapter<MyAppointmentsRecyclerViewAdapter2.ViewHolder> {

    private final List<Appointment> mValues;
    private OnListInteractionListener listener;

    public MyAppointmentsRecyclerViewAdapter2(List<Appointment> items, OnListInteractionListener listener) {
        mValues = items;
